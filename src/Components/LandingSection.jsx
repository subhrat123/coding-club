      ...
      <div className="relative z-10 flex mt-10 justify-center max-md:h-full md:min-h-[80vh]">
        <div className="text-center align-bottom text-white px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:gap-20 max-md:gap-48 w-full h-[90vh] relative max-md:top-12 md:top-40 sm:top-60 lg:top-80">
            <div
              className="mt-9 h-18 text-3xl sm:text-5xl lg:text-7xl shadow-2xl font-semibold font-sora animate-fadeIn text-width transition-all duration-500 ease-in-out text-transparent inline-block bg-clip-text bg-gradient-to-r from-purple-100 to-purple-600"
            ...
            <div className="flex flex-col gap-16">
              <p
                ...
                style={{ fontFamily: "Sora, sans-serif" }}
              >
                Dive into the world of innovation, creativity, and
                collaboration! Our club is a hub for tech enthusiasts,
                developers, and learners who aim to explore the vast field of
                coding. Whether you are a beginner or an expert, there's a place
                for you here.
              </p>
